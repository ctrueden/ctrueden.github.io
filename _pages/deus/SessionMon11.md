Today is Friday, July 18th, 2399.  As a reminder, ((CharPublicAlex|Ariona)), ((CharPublicJoey|Meechum)), and ((CharPublicKelsey|Eddie)), along with the body of ((NPCCain|Cain)), are hanging out in the vicinity of the asteroid belt aboard ((CharPublicGriffin|DEE)).  ((CharPublicNate|Ned)) is in Valhalla, attempting to contact ((CharPublicJohn|Matt Smith)), ((CharPublicEva|Rae Denison)), ((CharPublicMike|Vadril Korlax)), and ((CharPublicJames|Zee)).  ((CharPublicJon|Nikolai)) went home to visit his folks, ((CharPublicAllen|Vittorio)) is on Earth attempting to contact his father and the "organization," and ((CharPublicAndy|Brice)) is somewhere in the security network on Pax. 

Ned speaks to Ariona about a researcher at ((OrgStratCo|StratCo)) who has been researching "the white stuff," the xenobiological compound which is bonded with the nanites and which dampens mystic energies, absorbs them, and energizes itself with them.  Supposedly, ((NPCAdana|Adana Cassenti)) told him that someone at ))StratCo(( is working on this project.  Ariona asks if this is ((NPCEvan|Evan)), Adana's twin brother who is now running ))StratCo((.  Ned replies that he got the impression that it was more of a grunt there.  Ariona mentions that a lot of people work for ))StratCo(( and don't know it; for example, she used to.  She used to work on a project that was funded by ))StratCo((, but her boss didn't tell anyone where the money was coming from.  In fact, her old boss, ((NPCBernstein|Rudolph Bernstein)), is actually working more directly for ))StratCo(( now, according to the publicity.  At Ned's request, Ariona sends a message to Bernstein, asking him to contact her.  However, it is not flagged as urgent, and he does not respond immediately. 
...
At 0400 GMT, news broadcasters around the galaxy began running a disturbing story.  Apparently, a terrorist is attacking the main mysticport on ((Worlds|Lupus)), demanding that if ((NPCMerlin|Merlin Huntington)), second-in-command to ((NPCKhan|General Khan Ji-Tae)), the founder and leader of Lupus, is not turned over to him immediately, he will kill 20 hostages per hour.  He has a group of over 200 individuals at this point.  The man does not look familiar, but has displayed powers with which everyone is quite familiar -- the nanite-tech of ((NPCBryant|Harry Bryant)). 
