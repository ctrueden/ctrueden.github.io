...
This is my first post in a while; I've been busy with lots of things, including working on a more philosophically-oriented post about anarcho-primitivism, environmentalism, anthropology, economics and other such topics, thanks to some recent discussions with [bitches_tyrone](https://bitches_tyrone.livejournal.com/). Hopefully I'll be able to finish that soon.
