---
title: "Video games + Smash Bros Brawl"
date: 2008-02-03 19:27:00 -0600
mood: optimistic
song: "Goo Goo Dolls - Cuz You're Gone"
original_url: https://restless-coder.livejournal.com/38675.html
---
...
At first, I thought it might work to have an anime-night-style voting system where people choose the games to play. But upon further reflection I'm not sure it would be so good. I don't want to create another weekly obligation—maybe once a month, or just sporadically—and I also don't think it would work well with rigid time restrictions per game.

In addition, I think it would be fun to expose ourselves to more "new" (to us) games. So instead, how about:

1. Choose a system (e.g., we could start with the NES).
2. List all multiplayer games officially released in the U.S., alphabetically.
3. Play each game on the list, in order, until we are bored with it.
4. Repeat for as many sessions as it takes to get from A to Z.
5. Do it again with another system.

Games that suck would only be played for a short time. Awesome games might take hours until we move on. Single player games would be excluded because we don't really want to sit there while one person plays through FF6, though we could make exceptions.

Other ideas:

* Note any games that are fun enough to warrant further play on a "good games" list.
...
* We can occasionally play modern console games and PC games, too—whatever is most fun.

Another thing I like about this idea is that it requires very little preparation on anyone's part, meaning it wouldn't detract too badly from my other projects. I am still planning to have another Jolt Cola Cup—preparations just got put on hold for a while, but I haven't given up on it. And I want to run a D&D 4E campaign after it is released later this year (but starting no earlier than autumn).
